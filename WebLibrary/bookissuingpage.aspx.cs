    ...
    public partial class bookissuingpage : System.Web.UI.Page
    {
        ...
        void getNames()
        {
            try
            {
                ...
                SqlCommand cmd1 = new SqlCommand("select full_name from member_master_tbl where member_id = '" + TextBox2.Text.Trim() + "'", con);
        ...
        void issuebook()
        {
            try
            {
                ...
                con.Close();
                Response.Write("<script>alert('Book issues successfully');</script>");
                GridView1.DataBind();
            }
            catch (Exception ex)
            {
        ...
        void returnbook()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("delete from book_issue_tbl where member_id = '"+TextBox2.Text.Trim ()+"' and book_id = '"+TextBox1.Text.Trim()+"'", con);
